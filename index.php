...
<head>
	...
	<script src="node_modules/contactable/jquery.validate.min.js"></script>
		...
		<form class="sms" style="<?php echo $formStyle; ?>" id="messageForm" action="send.php" method="post">
			...
			<p>
				<div style="position: relative;">
					<textarea maxlength="70" name="message" id="messageSMS" rows="4" oninput="updateCounter(this)" required placeholder="Текст сообщения..."></textarea>
